...
function isFriaApplicable(sector: string, isProfiling: boolean): boolean {
  // Art. 27 applies to: public bodies, private entities providing public services,
  // and deployers of Annex III points 5(b) and (c) (insurance, credit)
...
function getNextSteps(
  ...
  sector: string,
  isProfiling: boolean,
  _materialInfluenceExceeded: boolean
